...
if($sql_ins==true)
	...
	$msg="Insert Error:".mysql_error($con);
                	...
                	<select name="techtxt" id="textbox">
                    	<option>---- Teachers's Name   ----</option>
                            <?php
								...
								while($row=mysqli_fetch_array($con,$te_name)){
            	...
            	<td>
                	<select name="factxt" id="textbox">
                    	<option>---- Facuries's Name   ------</option>
                            <?php
                               $fac_name=mysqli_query($con,"SELECT * FROM facuties_tbl");
							   while($row=mysqli_fetch_array($fac_name,MYSQLI_ASSOC)){
								?>
            	...
            	<td>
                	<select name="techtxt" id="textbox">
                    	<option>---- Teachers's Name   ----</option>
                            <?php
                                $te_name=mysqli_query($con,"SELECT * FROM teacher_tbl");
								while($row=mysqli_fetch_array($te_name,MYSQLI_ASSOC)){
								?>
